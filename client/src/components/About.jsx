  ...
  return (
    <section className="bg-primary-skill blur-background-filter bg-opacity-50 px-[10vh]">
      <div className="flex justify-center">
        <div className="flex w-[35vh] h-full m-8 justify-center items-center text-pf-dp text-6xl rounded-xl p-2 text-f-secondary">
          <h2 className="m-2">About Me</h2>
        </div>
      </div>
      <div className="flex justify-center">
        <div className="grid grid-cols-1 w-[160vh] h-[30vh] mx-8 mb-8 justify-items-center items-center text-pf-dp rounded-xl text-lg font-normal text-f-secondary text-center">
          <p className="w-2/3">
          ...
          <p className="w-2/3">Also it's a letter for the future-me.</p>
          <p className="w-2/3">
